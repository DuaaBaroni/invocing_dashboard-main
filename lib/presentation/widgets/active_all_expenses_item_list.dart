...
class ActiveAllExpensesItemList extends StatelessWidget {
  const ActiveAllExpensesItemList({
    super.key,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          FittedBox(
             fit: BoxFit.scaleDown,
            child: Text(itemModel.date,style: getTitleStyle(context,color: AppColors.grey))),
          Gap(8),
          FittedBox(
            fit: BoxFit.scaleDown,
            child: Text(itemModel.price, style: getTitleStyle(context,color: AppColors.blue, fontSize: 20))),
        ],
      ),
    );
  }
